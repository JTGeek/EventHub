...
function showEvents(event) {
    ...
    console.log("date: " + d1);
    $("#listTable").append("<tr><td>" + event.name + "</td><td>" + event._embedded.venues[0].name + "</td><td>" + event.distance + " miles</td><td>" + d1.toString('dddd, MM/dd/dd') + "</td><td>" + d1.toString('h: mm t') + "</td><td>" + "<a target='_new' href='" + event.url + "'><button>Buy Tickets</button></a></td></tr>");
